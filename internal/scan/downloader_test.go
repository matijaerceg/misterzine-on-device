...
func TestDownloaderDBs(t *testing.T) {
	...
	if got := data.HiddenSources(dbs); !reflect.DeepEqual(got, map[string]bool{"jtbindb": true, "kuzecores": true, "rmcores": true, "slopcore": true, "theypsilon_unofficial_distribution": true}) {
